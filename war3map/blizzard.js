    ...
    var bj_MAX_PLAYERS                   =  12
    var bj_PLAYER_NEUTRAL_VICTIM         =  13
    var bj_PLAYER_NEUTRAL_EXTRA          =  14
    var bj_MAX_PLAYER_SLOTS              =  16
    ...
    var bj_CAMPAIGN_OFFSET_XN      = 0
    var bj_CAMPAIGN_OFFSET_XH      = 1
    var bj_CAMPAIGN_OFFSET_XU      = 2
    var bj_CAMPAIGN_OFFSET_XO      = 3
...
function PercentToInt(percentage,max) {
    var result = R2I(percentage * I2R(max) * 0.01)
...
function SetSoundOffsetBJ(newOffset,soundHandle) {
    SetSoundPlayPosition(soundHandle, R2I(newOff* 1000))
}
...
function PlayMusicExBJ(musicFileName,startingOffset,fadeInTime) {
    bj_lastPlayedMusic = musicFileName
    PlayMusicEx(musicFileName, R2I(startingOff* 1000), R2I(fadeInTime * 1000))
}


function SetMusicOffsetBJ(newOffset) {
    SetMusicPlayPosition(R2I(newOff* 1000))
}
...
function PlayThematicMusicExBJ(musicName,startingOffset) {
    PlayThematicMusicEx(musicName, R2I(startingOff* 1000))
}


function SetThematicMusicOffsetBJ(newOffset) {
    SetThematicMusicPlayPosition(R2I(newOff* 1000))
}
...
function SetMissionAvailableBJ(available,missionIndex) {
    var campaignNumber = missionIndex / 1000
...
function SetCampaignAvailableBJ(available,campaignNumber) {
    ...
    if ((campaignNumber == bj_CAMPAIGN_INDEX_XN)) {
        campaignOff= bj_CAMPAIGN_OFFSET_XN
    } else if ((campaignNumber == bj_CAMPAIGN_INDEX_XH)) {
        campaignOff= bj_CAMPAIGN_OFFSET_XH
    } else if ((campaignNumber == bj_CAMPAIGN_INDEX_XU)) {
        campaignOff= bj_CAMPAIGN_OFFSET_XU
    } else if ((campaignNumber == bj_CAMPAIGN_INDEX_XO)) {
        campaignOff= bj_CAMPAIGN_OFFSET_XO
    } else {
        campaignOff= campaignNumber
    }
...
function MeleePlayerIsCrippled(whichPlayer) {
    var allyStructures    = MeleeGetAllyStructureCount(whichPlayer)
    var allyKeyStructures = MeleeGetAllyKeyStructureCount(whichPlayer)
